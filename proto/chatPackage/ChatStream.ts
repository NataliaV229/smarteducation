...
export interface ChatStreamClient extends grpc.Client {
...
export interface ChatStreamHandlers extends grpc.UntypedServiceImplementation {
  Chat: grpc.handleBidiStreamingCall<_chatPackage_ChatRequest__Output, _chatPackage_ChatResponse>;
  
}

export interface ChatStreamDefinition extends grpc.ServiceDefinition {
